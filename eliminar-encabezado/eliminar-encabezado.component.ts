...
@Component({
  selector: 'app-eliminar-encabezado',
  templateUrl: './eliminar-encabezado.component.html',
  styleUrls: ['./eliminar-encabezado.component.css']
})
export class EliminarEncabezadoComponent implements OnInit{
